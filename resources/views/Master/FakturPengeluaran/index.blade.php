            ...
            <div class="card mb-4 shadow-sm rounded-3">
                <div class="card-body">
                    ...
                    <div class="d-flex card-footer justify-content-between align-items-center">
                        ...
                        <a href="{{ route('fakturPengeluaran.view', $faktur->no_fk) }}" class="btn btn-success" style="background-color: #4154f1;">View</a>
                    </div>
                </div>
            </div>
        </div>
